...
// More Constants :)
constexpr double inv_masses[] = { 1.836152673e3, 1.0, 1.0 }; //This is in AU (1AU ~ 1 proton ~ 1 nuetron.
constexpr double charges[] = { -1.0, 1.0, 0.0 };

//refer to equations.ipynb to see why these value is what it is. 
constexpr double coulomb_scalar = 1.381228459e8; //AU*nanometers^3/second^2
constexpr double yukawa_scalar = 1.177325499e9;    //Experimentally obtained - AU*nanometers^3/second^2
constexpr double yukawa_radius = 1.4e-6;			 //Radius of strength.
constexpr double yukawa_cutoff = 1e-6;          //Sweet spot. (Strong force likes to be between 0.8 and 1.4 fm.
