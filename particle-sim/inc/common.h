...
constexpr float coulomb_scalar = 1.381228459e11; //AU*nanometers^3/second^2
constexpr float yukawa_scalar = -1.177325499e12;    //Experimentally obtained - AU*nanometers^3/second^2
